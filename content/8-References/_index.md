...
In repository, there is a way for testing at local. In `Actions`, there is history of deployment process to EC2 via Github Actions

Link repository: [https://github.com/Sheva2903/diy-shop](https://github.com/Sheva2903/diy-shop)
